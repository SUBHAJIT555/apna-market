...
const iconWrapClass =
  "flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-green-600/10 text-green-600";
            ...
            <div className="lg:col-span-4">
              <div className={`${cardClass} lg:sticky lg:top-28`}>
                <div className="border-b border-neutral-300 px-5 py-4 sm:px-6">
                  ...
                  <p className="mt-1 text-sm text-dark-4">We&apos;re here to help</p>
                </div>
                ...
                <div className="flex flex-col gap-4 p-5 sm:p-6">
                  <div className="flex items-start gap-4 rounded-xl border border-neutral-300 bg-gray-1 p-4">
                    ...
                    <div>
                      <p className="mb-0.5 text-sm font-medium text-dark">Email</p>
                      <a
                  ...
                  <div className="flex items-start gap-4 rounded-xl border border-neutral-300 bg-gray-1 p-4">
                    ...
                    <div>
                      <p className="mb-0.5 text-sm font-medium text-dark">Phone</p>
                      <a
                  ...
                  <div className="flex items-start gap-4 rounded-xl border border-neutral-300 bg-gray-1 p-4">
                    ...
                    <div>
                      <p className="mb-0.5 text-sm font-medium text-dark">Address</p>
            ...
            <div className="lg:col-span-8">
              <div className={cardClass}>
                <div className="border-b border-neutral-300 px-5 py-4 sm:px-6">
                  ...
                  <h3 className="mt-1 text-lg font-semibold text-dark">Send a Message</h3>
                  <p className="mt-1 text-sm text-dark-4">Fill in the form below</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-5 sm:p-6 lg:p-8">
                  ...
                  {error && (
                    <p
                      className="mb-4 rounded-xl border border-red/30 bg-red/5 px-4 py-3 text-sm text-red"
                      role="alert"
                    >
                      {error}
                    </p>
                  ...
                  {success && (
                    <p className="mb-4 rounded-xl border border-green-600/20 bg-green-600/5 px-4 py-3 text-sm text-green-700">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="inline-flex w-full items-center justify-center rounded-xl bg-green-600 px-7 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-green-700 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
                  >
