...
const SingleItem = ({ item }: { item: CartItem }) => {
  ...
  return (
    <article className="rounded-2xl border border-neutral-300 bg-white p-4 sm:p-5">
      <div className="flex gap-4 sm:gap-5">
        <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-white sm:h-24 sm:w-24">
          {productImage ? (
            ...
            <span className="text-xs text-dark-4">No image</span>
          )}
        </div>
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              ...
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-neutral-300 bg-white text-dark-4 transition-colors hover:border-orange-600/40 hover:text-orange-600 active:scale-95"
            >
          ...
          <div className="mt-4 flex flex-col gap-4 border-t border-neutral-300 pt-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
            ...
            <div>
              <p className="mb-1.5 text-xs text-dark-4">Quantity</p>
              <div className="inline-flex items-center overflow-hidden rounded-xl border border-neutral-300 bg-white">
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center text-dark-4 transition-colors hover:bg-gray-1 hover:text-dark disabled:cursor-not-allowed disabled:opacity-40"
                >
                ...
                <span className="flex h-10 min-w-[2.5rem] items-center justify-center border-x border-neutral-300 px-2 text-sm font-semibold text-dark">
                  {quantity}
                </span>
                <button
                  type="button"
                  ...
                  className="flex h-10 w-10 items-center justify-center text-dark-4 transition-colors hover:bg-gray-1 hover:text-dark"
                >
                  <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor" aria-hidden>
                    ...
                    <path d="M9.99967 16.6667C9.53944 16.6667 9.16634 16.2936 9.16634 15.8334V4.16671C9.16634 3.70647 9.53944 3.33337 9.99967 3.33337C10.4599 3.33337 10.833 3.70647 10.833 4.16671V15.8334C10.833 16.2936 10.4599 16.6667 9.99967 16.6667Z" />
                  </svg>
                </button>
              </div>
            </div>
            ...
            <div className="sm:text-right">
              <p className="text-xs text-dark-4">Subtotal</p>
              <p className="mt-0.5 text-base font-bold text-dark">
