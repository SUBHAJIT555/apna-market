      ...
      <div className="flex gap-4 sm:gap-5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-4 flex flex-col gap-4 border-t border-neutral-300 pt-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
              <p className="mb-1.5 text-xs text-dark-4">Availability</p>
              <span
            ...
            <button
              ...
              disabled={!inStock}
              className="inline-flex shrink-0 items-center justify-center rounded-xl bg-green-600 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-green-700 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 sm:px-6"
            >
              Add to Cart
            </button>
          </div>
