  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-0 top-1/2 z-[9997] flex h-12 w-11 -translate-y-1/2 items-center justify-center rounded-r-2xl bg-white text-green-600 shadow-[0_4px_24px_rgba(25,25,25,0.14)] transition-colors hover:text-green-700 xl:hidden"
      >
        <svg
      ...
      <section className="relative overflow-hidden bg-gray-1 pb-16 pt-8 lg:pb-20 lg:pt-12">
        <div className="mx-auto w-full max-w-[1170px] px-4 sm:px-8 xl:px-0">
          ...
          <div className="sticky top-20 z-40 mb-5 xl:hidden">
            <button
              ...
              onClick={openFilterSidebar}
              aria-label="Open filters"
              className="flex w-full items-center justify-center gap-2.5 rounded-2xl border border-neutral-300 bg-white py-3 text-sm font-medium text-green-600 shadow-sm transition-colors hover:border-green-600/40 hover:text-green-700"
            >
              <svg
                className="shrink-0"
                width="20"
          ...
          <div className="flex gap-6 lg:gap-7.5">
            ...
            >
              <form onSubmit={(e) => e.preventDefault()}>
                <div className="flex flex-col gap-6">
                  <div className="flex items-center justify-between border-b border-neutral-300 pb-4 xl:hidden">
                    ...
                    <button
                      ...
                      onClick={() => setProductSidebar(false)}
                      aria-label="Close filters"
                      className="flex h-9 w-9 items-center justify-center text-dark transition-colors hover:text-green-600"
                    >
                      <svg
                        width="22"
                        height="22"
                  ...
                  <div className="rounded-2xl border border-neutral-300 bg-white px-5 py-4">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="text-custom-sm font-medium text-green-600 transition-colors hover:text-green-700"
                      >
                        Clear all
                      </button>
                    </div>
            ...
            <div className="xl:max-w-[870px] w-full">
              <div className="mb-6 rounded-2xl border border-neutral-300 bg-white py-3 pl-3 pr-2.5">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                    <button
                      ...
                      onClick={openFilterSidebar}
                      aria-label="Open filters"
                      className="flex h-9 shrink-0 items-center gap-2 rounded-xl border border-neutral-300 bg-gray-1 px-3 text-sm font-medium text-green-600 transition-colors hover:border-green-600/40 hover:text-green-700 xl:hidden"
                    >
                      <svg
                        className="shrink-0"
                        width="20"
                  ...
                  <div className="flex items-center gap-2.5">
                    <button
                      ...
                      className={`${productStyle === "grid"
                        ...
                        : "border-neutral-300 bg-white text-dark"
                        } flex h-9 w-10.5 items-center justify-center rounded-xl border transition-colors duration-200 hover:border-green-600 hover:bg-green-600 hover:text-white`}
                    >
                      <svg
                        className="fill-current"
                        width="18"
              ...
              >
                {currentProducts.length === 0 ? (
                  <div className="col-span-full rounded-2xl border border-neutral-300 bg-white px-6 py-16 text-center">
                    <p className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-dark-4">
                      No results
                    </p>
                    ...
                    <button
                      type="button"
                      onClick={handleClearFilters}
                      className="mt-6 inline-flex items-center justify-center rounded-full bg-green-600 px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-green-700"
                    >
                      Clear all filters
                    </button>
                  </div>
                          ...
                          {page === '...' ? (
                            ...
                            <button
                              ...
                              className={`flex py-1.5 px-3.5 duration-200 rounded-[3px] ${currentPage === page
                                ...
                                : "text-dark hover:bg-green-600 hover:text-white"
                                }`}
                            >
                              {page}
                            </button>
