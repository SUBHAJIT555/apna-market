        ...
        <div id="pricingOne">
          <div className="price-range">
            ...
            <div className="price-amount flex items-center justify-between pt-4">
              <div className="flex rounded-lg border border-neutral-300 text-custom-xs text-dark-4">
                <span className="block border-r border-neutral-300 bg-gray-1/80 px-2.5 py-1.5">₹</span>
