...
// Brand palette: Blazing Flame, Carbon Black, Forest Moss, Alabaster Grey, Lavender

export const brandColors = {
  blazingFlame: "#F15025",
  carbonBlack: "#191919",
  forestMoss: "#447604",
  alabasterGrey: "#DDDDDD",
  lavender: "#EEEEFF",
} as const;
...
// Default theme: Blazing Flame (#F15025) as primary accent
export const defaultColors: ColorPalette = {
  primary: brandColors.blazingFlame,
  primaryDark: "#C93D14",
  primaryLight: "#F36747",
  primaryLight2: "#F67E62",
  primaryLight3: "#F9A08C",
  primaryLight4: "#FBC4B8",
  primaryLight5: "#FEEAE4",
};
...
export const presetColors = [
  { name: "Blazing Flame", value: brandColors.blazingFlame },
  { name: "Forest Moss", value: brandColors.forestMoss },
  { name: "Carbon Black", value: brandColors.carbonBlack },
